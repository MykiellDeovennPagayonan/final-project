  ...
  return (
    <>
      <div className="h-screen w-screen relative overflow-hidden">
        <div className=" shadow:lg shadow-green-300 xl:h-[77%] xl:w-[88%] h-[60%] w-[80%] sm:h-[77%] sm:w-[88%] m-auto bg-opacity-50 rounded-2xl bg-green-200 border border-[#173137] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden">
